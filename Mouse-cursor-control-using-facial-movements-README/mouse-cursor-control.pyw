...
class Datos():
    ...
    def set_datosActualizados(self):
        ...
        self.lista.append(self.get_datosVerificados(self.d1))
...
shape_predictor = "c:/tesis/Mouse-cursor-control-using-facial-movements-README/model/shape_predictor_68_face_landmarks.dat"
...
while True:
    ...
    # Verificar si la ventana está abierta o no
